...
class ToDoPendingTVC: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        let colorTop =  UIColor(red: 26.0/255.0, green: 131.0/255.0, blue: 255.0/255.0, alpha: 1.0).cgColor
        let colorBottom = UIColor(red: 0.0/255.0, green: 66.0/255.0, blue: 255.0/255.0, alpha: 1.0).cgColor
